...
class Binarios:
    ...
    binarioOlimpiadas = "binarios/olimpiadas"
    ...
    def crearSerializableOlimpiadas(self):
        with open(self.xmlOlimpiadas) as xmlol:
            ...
            with open(self.binarioOlimpiadas, "wb") as binario:
                pickle.dump(listol, binario)
    ...
    def engadirEdicion(self):
        if os.path.exists(self.binarioOlimpiadas):
            ...
            with open(self.binarioOlimpiadas, "rb") as binol:
                lista = pickle.load(binol)
                lista.append(ol)
                with open(self.binarioOlimpiadas, "wb") as binolw:
                    pickle.dump(lista, binolw)
        else:
